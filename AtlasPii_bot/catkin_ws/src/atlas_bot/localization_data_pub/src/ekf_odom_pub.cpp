...
const double TICKS_PER_REVOLUTION = 360; // For reference purposes.
const double WHEEL_RADIUS = 0.055; // Wheel radius in meters
const double WHEEL_BASE = 0.32; // Center of left tire to center of right tire
const double TICKS_PER_METER = 1100; // Original was 2800
